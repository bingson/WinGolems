...
; ACTIVATE APPS (GREEN) ________________________________________________________
  ...
  ^!F1::              SaveWinID("F1")                                           ;Apps: Save window ID 
  ^!F2::              SaveWinID("F2")                                           ;Apps: Save window ID
  ^!F3::              SaveWinID("F3")                                           ;Apps: Save window ID
  ^!F4::              SaveWinID("F4")                                           ;Apps: Save window ID
  ^!F5::              SaveWinID("F5")                                           ;Apps: Save window ID
  ^!F6::              SaveWinID("F6")                                           ;Apps: Save window ID
  ^!F7::              SaveWinID("F7")                                           ;Apps: Save window ID
  ^!F8::              SaveWinID("F8")                                           ;Apps: Save window ID
  #F1::               ActivateWinID("F1")                                       ;Apps: Activate saved window ID
  #F2::               ActivateWinID("F2")                                       ;Apps: Activate saved window ID
  #F3::               ActivateWinID("F3")                                       ;Apps: Activate saved window ID
  #F4::               ActivateWinID("F4")                                       ;Apps: Activate saved window ID
  #F5::               ActivateWinID("F5")                                       ;Apps: Activate saved window ID
  #F6::               ActivateWinID("F6")                                       ;Apps: Activate saved window ID
  #F7::               ActivateWinID("F7")                                       ;Apps: Activate saved window ID
  #F8::               ActivateWinID("F8")                                       ;Apps: Activate saved window ID
...
; CONVENIENCE (ORANGE) _________________________________________________________
  ...
  #esc::              suspend                                                   ;Convenience: toggle all hotkeys ON|OFF except for this one
  ...
  #Lbutton::                                                                    ;Convenience: open start menu (alt: Ctrl+Esc)
  $^#Enter::          send ^{esc}                                               ;Convenience: open start menu 
