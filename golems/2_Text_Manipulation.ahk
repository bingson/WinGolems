; CONVENIENCE/TEXT MANIPULATION ________________________________________________
  ...
  $!v::             FormatBreaks("no break")                                    ;TEXT MANIPULATION| replace multiple paragraph breaks with space (remove paragraphs breaks)
  $+!v::            FormatBreaks("1 break")                                     ;TEXT MANIPULATION| replace multiple paragraph breaks w/ 1 break in selected text
  ...
  $+!sc029::        Clip("`````` " Clip() " ``````")                            ;TEXT MANIPULATION: enclose selected text with ``` ```
  $!#8::            ReplaceAwithB("*")                                          ;TEXT MANIPULATION: remove * from selected text
